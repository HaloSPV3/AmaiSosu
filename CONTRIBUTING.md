# Contributing to AmaiSosu

Welcome to AmaiSosu!
> The alternative installer for OpenSauce's client files!

The following is a set of guidelines for contributing to AmaiSosu. Code style is recommended, but not required. However, due to the presence of automated tasks affecting this repository, we require [conventional commits](https://www.conventionalcommits.org)\* for inferring the release version from commit messages.
...
- **Your choice of Editor/IDE**
  - **Visual Studio Code**
    ...
    - Features:
      ...
      - Stage and commit selections (in Changes editor) or stage _individual changes_ in the normal editor to commit later
  - **Visual Studio IDE**
    - Windows-exclusive
...
`git remote add upstream https://github.com/HaloSPV3/AmaiSosu.git && git fetch --all --tags --recurse-submodules`.
